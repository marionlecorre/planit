 ...
 */
class Version20141228153708 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6D76B53157B581A4 ON guest (type_guest_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6D76B53157B581A4 ON Guest');
